...
var menuAprendiz = function menuAprendiz(req, res) {
  res.render('menu-aprendiz.ejs');
};
var controlCompu = function controlCompu(req, res) {
  res.render('controlcom.ejs');
};
var formularioPC = /*#__PURE__*/function () {
  ...
  return function formularioPC(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var seguimientoA = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var datosReserva, rutaReserva, getOptions, getResponse, _datosReserva;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 6;
          return (0, _nodeFetch["default"])(rutaReserva, getOptions);
        case 6:
          getResponse = _context2.sent;
          _context2.next = 9;
          return getResponse.json().then(function (response) {
            return response.json();
          }).then(function (data) {
            data[0], _readOnlyError("datosReserva");
            console.log(data[0]);
          })["catch"](function (err) {
            return console.error("error en peticion" + err);
          });
        case 9:
          _datosReserva = _context2.sent;
          res.render('seguimientoA', {
            datosReserva: _datosReserva
          });
          _context2.next = 17;
          break;
        case 13:
  ...
  return function seguimientoA(_x3, _x4) {
...
var InsertarComputador = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          break;
        case 11:
          return _context3.abrupt("return", res.redirect("/prestamoPc2?alerta=1"));
        case 12:
          _context3.next = 18;
          break;
        case 14:
          ...
          return _context3.abrupt("return", res.redirect("/?alerta=2"));
        case 18:
        case "end":
  ...
  return function InsertarComputador(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var Insertareportepc = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          break;
        case 11:
          return _context4.abrupt("return", res.redirect("/controlcom?alerta=1"));
        case 12:
          _context4.next = 18;
          break;
        case 14:
          ...
          // Manejar la respuesta del servidor cuando no es válida
          return _context4.abrupt("return", res.redirect("/?alerta=2"));
        case 18:
        case "end":
  ...
  return function Insertareportepc(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var aprendizController = {
  menuAprendiz: menuAprendiz,
  controlCompu: controlCompu,
  Insertareportepc: Insertareportepc,
  formularioPC: formularioPC,
  InsertarComputador: InsertarComputador,
  seguimientoA: seguimientoA
};
