...
var rolAdmin = function rolAdmin(req, res) {
  res.render("rol.ejs", {
    errorr: req.query.errorr
  });
};
var devolucionInsumos = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var rutaRegistro, rutaPrestamo, opciones, _yield$Promise$all, _yield$Promise$all2, datosReserva, datosPrestamo, datosPrestamoFiltrados;
...
var actualizarEstado = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var idPrestamo, estado, UpdateEstado, ruta, option;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          idPrestamo = req.query.id;
  ...
  return function actualizarEstado(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var insumosNoDevueltos = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var rutaRegistro, rutaPrestamo, opciones, _yield$Promise$all3, _yield$Promise$all4, datosReserva, datosPrestamo, datosPrestamoFiltrados;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 6:
          ...
          datosReserva = _yield$Promise$all4[0];
          datosPrestamo = _yield$Promise$all4[1];
          // Filtrar los datos para mostrar solo los elementos con el estado "ENTREGADO"
          datosPrestamoFiltrados = datosPrestamo[0].filter(function (element) {
  ...
  return function insumosNoDevueltos(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();

// Cuando el documento está listo, se ejecuta la función de devolución de llamada.
var validarRol = function validarRol(req, res) {
  var selectedValue = req.body.selectRol;
  if (!selectedValue) {
...
var solicitud = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var rutaRegistro, opciones, getResponse, datosReserva;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 5;
          return (0, _nodeFetch["default"])(rutaRegistro, opciones);
        case 5:
          getResponse = _context4.sent;
          _context4.next = 8;
          return getResponse.json();
        case 8:
          datosReserva = _context4.sent;
  ...
  return function solicitud(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var usuariosRegistrados = /*#__PURE__*/function () {
  ...
  return function usuariosRegistrados(_x9, _x10) {
...
var administradorController = {
  ...
  devolucionInsumos: devolucionInsumos,
  insumosNoDevueltos: insumosNoDevueltos,
  actualizarEstado: actualizarEstado //actualizacion
};
