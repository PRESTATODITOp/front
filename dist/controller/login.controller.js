...
exports.validacionLogin = exports.loginController = void 0;
...
var validacionLogin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var credenciales, url, options, datos, response, data, verificarCredenciales;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 17:
          ...
          verificarCredenciales = function verificarCredenciales() {
            ...
            var rolesPermitidos = [1, 2, 3, 4];
            var rolSeleccionado = parseInt(req.body.rol);
            ...
            var token = _jsonwebtoken["default"].sign(datos, process.env.SECRET_KEY, {
  ...
  return function validacionLogin(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.validacionLogin = validacionLogin;
...
var denegado = function denegado(req, res) {
  res.render('cerrarsesion.ejs');
};
var loginController = {
